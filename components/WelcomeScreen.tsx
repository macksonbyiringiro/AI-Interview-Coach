    ...
    <div className="p-8 md:p-12">
      {isLoading ? (
        <div className="flex flex-col items-center justify-center min-h-[400px]">
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-300 text-lg">Generating your session...</p>
        </div>
      ) : (
        <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white mb-4">Choose Your Practice Mode</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                {/* Quiz Card */}
                <div className="bg-white dark:bg-slate-800/50 p-8 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col hover:border-cyan-500/50 transition-all">
                    <div className="flex-grow">
                        <BotIcon className="w-10 h-10 text-cyan-400 mb-4"/>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Multiple-Choice Quiz</h3>
                    ...
                    <form onSubmit={handleQuizSubmit} className="flex flex-col gap-3">
                        <input
                            ...
                            className="w-full px-4 py-3 bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none transition-shadow"
                ...
                <div className="bg-white dark:bg-slate-800/50 p-8 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col hover:border-cyan-500/50 transition-all">
                    <div className="flex-grow">
                        ...
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Voice Interview</h3>
                        <p className="text-slate-500 dark:text-slate-400 mb-6">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {suggestedTopics.map((suggestedTopic) => (
                  <button
                    ...
                    className="px-4 py-1 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-full text-sm hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors"
                  >
                    {suggestedTopic}
                  </button>
                ))}
